...
async function createNote() {
    ...
    await fetch("gatewayisoc-production.up.railway.app/api/note", {
        method: "POST",
...
async function loadNotes() {
    const res = await fetch(`gatewayisoc-production.up.railway.app/api/notes/${userId}`);
...
async function loadTags(noteId) {
    const res = await fetch(`gatewayisoc-production.up.railway.app/api/tags/${noteId}`);
...
async function addTag(noteId) {
    ...
    await fetch("gatewayisoc-production.up.railway.app/api/tag", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
